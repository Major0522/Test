...
public class MainController {
	...
	@FXML private Circle circle_HLeft, circle_HRight, circle_M1, circle_M2, circle_M3, circle_D1, circle_D2, circle_D3;
	@FXML private Line pilot_left, pilot_middle, pilot_right, left_arm, right_arm, pen_track;
	...
	protected void buttonAction() {
		...
		tl = new Timeline(
				new KeyFrame(Duration.seconds(0), new KeyValue(M1x, circle_M1.getCenterX()),
						new KeyValue(M1y, circle_M1.getCenterY()), new KeyValue(M2x, circle_M2.getCenterX()),
						new KeyValue(M2y, circle_M2.getCenterY()), new KeyValue(M3x, circle_M3.getCenterX()),
						new KeyValue(M3y, circle_M3.getCenterY())),
				new KeyFrame(Duration.seconds(animationOptions.getDuration()), new KeyValue(M1x, pilot_left.getEndX()),
						new KeyValue(M1y, pilot_left.getEndY()), new KeyValue(M2x, pilot_middle.getEndX()),
						new KeyValue(M2y, pilot_middle.getEndY()), new KeyValue(M3x, pilot_right.getEndX()),
	...
	private void calculatePenTrackPosition(DoubleProperty m1x, DoubleProperty m1y, DoubleProperty m2x,
			DoubleProperty m2y, DoubleProperty m3x, DoubleProperty m3y, double baseDistance) {
	...
	private void updateInterpolatedElements(DoubleProperty m1x, DoubleProperty m1y, DoubleProperty m2x,
			DoubleProperty m2y, DoubleProperty m3x, DoubleProperty m3y) {
	...
	private void sceneReset() {
		...
		setLineProperty(pilot_middle, circle_HLeft.getCenterX(), circle_HLeft.getCenterY(), circle_HRight.getCenterX(),
				circle_HRight.getCenterY());
		...
		setLineProperty(right_arm, circle_HLeft.getCenterX(), circle_HLeft.getCenterY(), circle_HRight.getCenterX(),
				circle_HRight.getCenterY());
